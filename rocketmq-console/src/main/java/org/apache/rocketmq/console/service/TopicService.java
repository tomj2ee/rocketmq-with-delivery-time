...
public interface TopicService {
    ...
    TopicConfig examineTopicConfig(String topic, String brokerName) throws MQBrokerException, RemotingException, InterruptedException;

    List<TopicConfigInfo> examineTopicConfig(String topic) throws MQBrokerException, RemotingException, InterruptedException;
