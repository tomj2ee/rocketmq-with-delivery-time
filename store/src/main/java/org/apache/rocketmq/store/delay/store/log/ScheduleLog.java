...
public class ScheduleLog implements Log<ScheduleIndex, LogRecord>, Disposable {
    ...
    public AppendLogResult<ScheduleIndex> appendScheduleLog(MessageExt msgExt) throws Exception {
        ...
        long scheduleTime = 0;
        String propertyScheduleTime = msgExt.getProperty(Message.SystemPropKey.STARTDELIVERTIME);
        ...
        msgExt.putUserProperty(Message.SystemPropKey.STARTDELIVERTIME,Long.toString(scheduleTime));
