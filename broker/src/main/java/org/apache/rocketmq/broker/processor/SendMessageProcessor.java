...
public class SendMessageProcessor extends AbstractSendMessageProcessor implements NettyRequestProcessor {
    ...
    private CompletableFuture<RemotingCommand> asyncSendMessage(ChannelHandlerContext ctx, RemotingCommand request,
        ...
        if (this.brokerController.getMessageStore().isDelayDeliveryTimeMsg(msgInner)) {
            ...
            RemotingCommand successResponse = RemotingCommand.createRequestCommand(ResponseCode.SUCCESS, sendMessageResponseHeader);
            successResponse.setOpaque(request.getOpaque());
            successResponse.addExtField(MessageConst.PROPERTY_MSG_REGION, this.brokerController.getBrokerConfig().getRegionId());
            successResponse.addExtField(MessageConst.PROPERTY_TRACE_SWITCH, String.valueOf(this.brokerController.getBrokerConfig().isTraceOn()));
