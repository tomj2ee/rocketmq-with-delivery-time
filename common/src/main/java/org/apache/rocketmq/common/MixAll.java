...
public class MixAll {
    ...
    public static final   String Default_Prefix="mu_env_prefix";
    ...
    public static   String wrapTopic(String topic) {
        String wrapPrefix = "TBMW_";
        String prefix = System.getProperty(Default_Prefix);
        if (!StringUtils.isEmpty(prefix) && !topic.contains(wrapPrefix)) {
            topic = wrapPrefix + prefix + topic;
        }
        return topic;
    }
